window.CreateProductComponent = React.createClass({
	...
	componentDidMount: function() {
	    this.serverRequest = $.get(window.location.origin+"/me/native-php-api/api/category/read.php", function (categories) {
	        this.setState({
	...
	onSave: function(e){
	    ...
	    $.ajax({
	        url: window.location.origin+"/me/native-php-api/api/product/create.php",
	        type : "POST",
	        contentType : 'application/json',
	        data : JSON.stringify(form_data),
	        success : function(response) {
	        	console.log('response showing ', response);
