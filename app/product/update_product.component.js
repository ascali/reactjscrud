...
window.UpdateProductComponent = React.createClass({
	...
	componentDidMount: function(){
	    ...
	    // read categories
	    this.serverRequestCat = $.get(window.location.origin+"/me/native-php-api/api/category/read.php",
	        function (categories) {
	            this.setState({
	    ...
	    this.serverRequestProd = $.get(window.location.origin+"/me/native-php-api/api/product/read_one.php?id=" + productId,
	        function (product) {
	...
	onSave: function(e){
	    ...
	    $.ajax({
	        url: window.location.origin+"/me/native-php-api/api/product/update.php",
	        type : "POST",
